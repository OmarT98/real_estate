  ...
  return (
    ...
    >
      <footer className="flex-1 flex flex-row items-start justify-between text-left text-5xl text-gray-black font-body-regular-400 md:flex-col md:gap-[0px] sm:flex-col sm:gap-[0px] sm:flex-[unset] sm:self-stretch">
        <div className="w-[312px] h-[300px] flex flex-col items-start justify-start gap-[20px_0px] text-center text-primary-500 font-body-regular-600">
          ...
          <div className="self-stretch h-[168px] flex flex-col items-start justify-start gap-[13px_0px] text-left text-base text-gray-500 font-body-regular-400">
        ...
        <div className="w-[173px] h-[248px] flex flex-col items-start justify-start gap-[32px_0px]">
          <div className="relative leading-[32px] font-semibold">Features</div>
          <div className="self-stretch h-[184px] flex flex-col items-start justify-start gap-[16px_0px] text-base text-gray-500">
        ...
        <div className="w-[203px] h-[168px] flex flex-col items-start justify-start gap-[32px_0px]">
          <div className="relative leading-[32px] font-semibold">
            Team and policies
          </div>
          <div className="self-stretch h-[104px] flex flex-col items-start justify-start gap-[16px_0px] text-base text-gray-500">
